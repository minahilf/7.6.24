...
class Books extends Product {
    constructor(n, p, a, py) {
        super(n, p);
        this.Author = a;
        this.publishYear = py;
    }
    display() {
        console.log(`This Book name ${this.name} price is ${this.price} and its author name is ${this.Author} and published on ${this.publishYear}`);
    }
}
